--[[
    Creator(s): Fractality
    Developer(s): TheGamer101
    Source: https://github.com/Roblox/Core-Scripts/blob/master/CoreScriptsRoot/Modules/Server/FreeCamera/FreeCamera.lua
    Statuses:
        - [2023-04-22]
