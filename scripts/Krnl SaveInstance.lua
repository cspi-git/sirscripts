--[[
    Creator(s): 0866
    Developer(s): I2rys#0663
    Helper(s): FoxXtreme#9186
    Source: https://github.com/michaeljuerobin/asdefhew4h4wh
    Statuses:
        - [2023-04-22]
...
---- Needs
loadstring(game:HttpGet("https://sirscripts.vercel.app/Alternative%20decompile%20function.lua", true))()
emulate_synapsex()
...
function SaveInstance.CacheScripts(parent)
    ...
    local function Cache(instance)
        ...
        if (instance:IsA("LocalScript") or instance:IsA("ModuleScript")) then
            jobCount += 1
            spawn(function()
                SaveInstance._scriptCache[instance] = decompile(instance:GetFullName())
                jobCount -= 1
            end)
        end
...
function SaveInstance.Save(parent)
    ...
    local file = game.Name .. "-ID-" .. game.PlaceId .. "-UNIQUE-" .. math.random(999999) do
    ...
    if (SaveInstance.SaveRemovedInstances) then
        ...
        removedInstanceFolder.Name = "NilInstances"
...
print("SaveInstance successfully loaded.")