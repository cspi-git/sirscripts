--[[
    Creator(s): 78n
    Source: https://github.com/78n/SimpleSpy
    Statuses:
        - [2023-04-22]
...
local Highlight = (isfile and loadfile and isfile("Highlight.lua") and loadfile("Highlight.lua")()) or loadstring(game:HttpGet("https://sirscripts.vercel.app/_libraries/higlight%20v0.0.1.lua"))()
...
if configs.supersecretdevtoggle then
    ...
    function()
        loadstring(game:HttpGet("https://sirscripts.vercel.app/packed%20scripts/SimpleSpyV3/SimpleSpyV2.lua"))()
    end)
    newButton("Load SSV3",function()
        return "Load's Simple Spy V3"
    end,
    function()
        loadstring(game:HttpGet("https://sirscripts.vercel.app/packed%20scripts/SimpleSpyV3/main.lua"))()
    end)
